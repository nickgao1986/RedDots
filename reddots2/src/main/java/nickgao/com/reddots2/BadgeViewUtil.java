...
public class BadgeViewUtil {
     ...
     * 默认背景颜色
     */
    private int mDefaultBackgroundColor = Color.parseColor("#ff527b");
    /**
     * 默认字体颜色
     */
    ...
    public void draw(Canvas canvas) {
        if (isShowBadge) {
            ...
            if (mCount > 0) {
                ...
                canvas.drawText(temp, mViewWidth - mBadgeWidth / 2 - mDefaultRightPadding-1.0f, baseline + mDefaultTopPadding-1, mTextPaint);
            }
        }
    }
